...
const BottomNav = ({ paginaAtual, onNavigate }: BottomNavProps) => {
  ...
  return (
    <nav className="absolute bottom-0 left-0 right-0 bg-white dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-800" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
