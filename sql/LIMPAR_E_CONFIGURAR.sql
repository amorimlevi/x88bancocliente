-- LIMPAR DUPLICATAS E CONFIGURAR TRIGGERS
...
-- 2. Remover carteiras duplicadas (mantém apenas a primeira de cada cliente)
...
-- 3. Criar ou substituir função para criar cliente após signup
...
-- 4. Criar ou substituir função para criar carteira após criar cliente
...
-- 8. Processar clientes existentes que não têm carteira
INSERT INTO public.carteira_x88 (cliente_id, saldo, saldo_bloqueado, total_recebido, total_gasto)
SELECT 
  c.id,
  0,
